...
const Cart = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-6 shs">
      <h1 className="font-serif text-3xl text-luxury-text mb-8">Your Cart</h1>

      {items.length === 0 ? (
        <p className="text-luxury-muted">Your cart is currently empty.</p>
      ) : (
        <div className="space-y-6">
          {items.map(estate => (
            ...
            >
              <div className="w-full md:w-56 h-40 rounded-lg overflow-hidden">
                <img
                  src={estate.image}
